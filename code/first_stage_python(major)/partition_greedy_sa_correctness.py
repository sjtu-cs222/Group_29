...
def main():
	...
	#simulated annealing end
		...
		time3=time2-time1
		#print ("time",time3)
		print("Op cost:" + str(cost_optimal))
		if(cost_greedy == cost_optimal):
			print("Greedy Op:"+str(cost_greedy))
			op_greedy += 1
		else:
			print("Greedy  not Op:"+str(cost_greedy))
		if(cost_sa == cost_optimal):
			print("SA Op:"+str(cost_sa))
			op_sa += 1
		else:
			print("SA not Op:"+str(cost_sa))
	print(op_greedy)
	print(op_sa)
	print()
main()
